...
public class ConfirmSentMessageTask extends AsyncTask<List<ConfirmMessage>, Void, String>{
	
	
	private static final String URL = "http://gustavo14779.cloudapp.net:8080/message/confirmsent/";
